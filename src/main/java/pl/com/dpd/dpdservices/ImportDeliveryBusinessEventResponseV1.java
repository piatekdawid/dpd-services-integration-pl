...
public class ImportDeliveryBusinessEventResponseV1  implements java.io.Serializable {
    ...
    private pl.com.dpd.dpdservices.ImportDeliveryBusinessEventStatusEnumV1 status;
    ...
    public ImportDeliveryBusinessEventResponseV1(
           ...
           pl.com.dpd.dpdservices.ImportDeliveryBusinessEventStatusEnumV1 status) {
     ...
     * @return status
     */
    public pl.com.dpd.dpdservices.ImportDeliveryBusinessEventStatusEnumV1 getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(pl.com.dpd.dpdservices.ImportDeliveryBusinessEventStatusEnumV1 status) {
        this.status = status;
    }
