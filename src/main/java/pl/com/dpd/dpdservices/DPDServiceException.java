...
public class DPDServiceException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getExceptionDate() != null) {
            _hashCode += getExceptionDate().hashCode();
        }
        if (getMessage1() != null) {
    ...
    static {
        ...
        elemField.setFieldName("exceptionDate");
        elemField.setXmlName(new javax.xml.namespace.QName("", "exceptionDate"));
