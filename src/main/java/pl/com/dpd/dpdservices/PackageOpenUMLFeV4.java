...
public class PackageOpenUMLFeV4  implements java.io.Serializable {
    ...
    private pl.com.dpd.dpdservices.ServicesOpenUMLFeV5 services;
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://dpdservices.dpd.com.pl/", "servicesOpenUMLFeV5"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
